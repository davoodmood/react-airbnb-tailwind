...
function Footer() {
    return (
        <>
            <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-y-10 px-24 py-14 bg-gray-100 text-gray-600">
            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 py-3 sm:py-0 sm:grid-cols-2 h-20 sm:px-16 items-center justify-between">
                    <div className="flex justify-center text-xs sm:justify-start space-x-2 flex-wrap ">
                        <p>© 2021 Airbnb, Inc. <span className="mx-1">.</span></p>
                        <p>Privacy <span className="mx-1">.</span></p>
                        <p>Terms <span className="mx-1">.</span></p>
                        <p>Sitemap</p>
                    </div>
                    <div className="flex justify-center text-xs sm:justify-end space-x-6">
                        <p className="flex cursor-pointer hover:text-gray-600">
                        ...
                        <p className="flex cursor-pointer hover:text-gray-600">
                            <CurrencyEuroIcon className="h-6 mr-1"/>
                            <span className=" underline hover:cursor-pointer">
                                Currency
                            </span>
                        </p>
